  ...
  <div class="pf-v6-c-page">
    <header class="pf-v6-c-masthead pf-m-display-inline-on-md" role="banner">
      <div class="pf-v6-c-masthead__main">
        <!-- Below xl the groups are a drawer, and without this there was no
             way to open it: the panel slid off the left and nothing in the
        ...
        <div class="pf-v6-c-masthead__brand">
          <!-- The name of the thing is the way back to it, which is what a
               masthead brand is everywhere else. .brand and the order of its
               two spans are what oem-loader.js writes a customer's icon and
               name into. -->
          <a class="pf-v6-c-masthead__logo brand" href="/admin">
